  ...
  return (
    <>
      <Dialog modal={false}>
        ...
        >
          <button className="fixed bottom-0 right-10 z-50 bg-[#120A21] border-pink-500 border border-b-0 flex items-center gap-3 shadow-[0_0_40px_rgba(0,0,0,0.20)] rounded-t-lg px-4 py-3 cursor-pointer justify-between">
