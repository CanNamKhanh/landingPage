function Footer() {
  return (
    <div className="w-full bg-[#F2E5F7] h-57 select-none">
      <div className="ts-1st-line flex items-center justify-between h-30 border-y border-[#f4d7ff] px-20">
        ...
        <div className="text-black/60 md:block hidden">
          Your trusted partner in game boosting. Fast, safe, and reliable
          service.
        </div>
        <div className="flex gap-5">
          <div className="bg-[#1B1B32] group w-10 h-10 rounded-full flex justify-center items-center cursor-pointer hover:bg-[#e6afff] transform duration-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              fill="white"
              width={20}
              className="group-hover:fill-[#B842F0] transform duration-300"
            >
      ...
      {/* End 1St Line */}
      <div className="ts-2nd-line text-black/60 text-center flex items-center justify-center h-20">
