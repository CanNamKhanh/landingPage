...
export default function ConnectionMenu() {
  ...
  return (
    <div className="fixed right-7 bottom-7 z-50 flex flex-col items-end gap-3">
      {/* MENU ITEMS */}
      {open && (
        <div className="flex flex-col items-end gap-3 animate-in slide-in-from-bottom-2 fade-in duration-200">
          {/* Discord */}
          <a href="https://discord.gg/9rWNTFA9y6" target="_blank">
            <Button
              size="icon"
              className="rounded-full bg-[#5865F2] hover:bg-[#4752c4] w-12 h-12 hover:scale-110 cursor-pointer"
            >
              <svg
          ...
          {/* Telegram */}
          <a href="https://t.me/rosieboost" target="_blank">
            <Button
              size="icon"
              className="rounded-full bg-[#2AABEE] hover:bg-[#229ED9] w-12 h-12 hover:scale-110 cursor-pointer"
            >
          ...
          {/* WhatsApp */}
          <a href="https://wa.me/84775602756" target="_blank">
            <Button
              size="icon"
              className="rounded-full bg-[#25D366] hover:bg-[#1ebe5d] w-12 h-12 hover:scale-110 cursor-pointer"
            >
          ...
          >
            <Button
              size="icon"
              className="rounded-full bg-[#1877F2] hover:bg-[#166fe0] w-12 h-12 hover:scale-110 cursor-pointer"
            >
      ...
      >
        {open ? (
          ...
          <MessageCircle className="text-white scale-120" />
        )}
      </Button>
    </div>
  );
