          ...
          <div className="grid grid-cols-2 gap-2 w-full">
            {contactLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="bg-[#25272D] hover:bg-[#2f3137] border border-black/10 text-black/80 hover:text-black text-sm font-medium py-2 px-4 rounded-lg transition-colors text-center"
              >
                {link.label}
              </a>
            ))}
