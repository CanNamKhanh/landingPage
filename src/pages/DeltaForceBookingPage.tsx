  ...
  return (
    <div className="rounded-xl bg-[#1D1D28] border border-[#B842F0]/20 p-4 flex items-start justify-between">
      <div>
        ...
        {price > 0 && <p className="text-xs text-white/50 mt-1">{label}</p>}
      </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={`bg-[#1D1D28] border rounded-md px-3 py-2 text-sm text-white placeholder:text-white/35 focus:outline-none transition-colors
            ${nameError ? "border-red-500" : "border-white/10 focus:border-[#B842F0]/60"}`}
        />
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={`bg-[#1D1D28] border rounded-md px-3 py-2 text-sm text-white placeholder:text-white/35 focus:outline-none transition-colors
            ${emailError ? "border-red-500" : "border-white/10 focus:border-[#B842F0]/60"}`}
        />
    ...
    <div className="flex flex-col gap-1.5 relative">
      ...
      <button
        ...
        className={`w-full flex justify-between items-center px-3 py-2 rounded-md text-sm font-medium transition-colors outline-none
          ${
            disabled
              ? "bg-[#1D1D28] border border-white/8 text-white/20 cursor-not-allowed"
              : showGreen
                ? "bg-[#B842F0]/10 border border-[#B842F0] text-white cursor-pointer"
                : "bg-[#1D1D28] border border-white/10 text-white/60 cursor-pointer hover:border-white/30"
          }`}
      >
        <span
          className={
              ...
              className={`py-2.5 px-3 rounded-lg border text-sm font-semibold transition-all cursor-pointer
                ${
                  selected.has(range)
                    ...
                    : "bg-[#1D1D28] border-white/10 text-white/70 hover:border-white/30 hover:text-white"
                }`}
            >
              {range}
            </button>
    ...
    <>
                  ...
                  ${
                    !available
                      ...
                      : isSelected
                        ...
                        : "bg-[#1D1D28] border-white/10 text-white/70 hover:border-white/30 hover:text-white cursor-pointer"
                  }`}
              >
                {diff}
              </button>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="bg-[#1D1D28] border border-white/10 rounded-md px-3 py-2 text-sm text-white placeholder:text-white/35 focus:outline-none focus:border-[#B842F0]/60 transition-colors"
        />
      </div>
...
function SeasonMissionTab() {
  ...
  return (
    <>
      {/* Info card */}
      <div className="rounded-xl bg-[#1D1D28] border border-white/10 p-4">
  ...
  return (
    <div className="min-h-screen bg-[#0F0F17] text-white">
      ...
      <div className="pt-36 pb-20 mx-auto max-w-2xl px-4">
        ...
        >
          <TabsList className="bg-[#17171F] w-full h-auto! grid grid-cols-3 gap-1 p-1">
            {DF_SERVICES.map((s) => (
              <TabsTrigger
                key={s}
                value={s}
                className="cursor-pointer text-xs md:text-sm py-2 text-white/60 hover:text-white data-[state=active]:text-white data-[state=active]:bg-[#B842F0]/15 data-[state=active]:shadow-none"
              >
                {s}
              </TabsTrigger>
            ))}
