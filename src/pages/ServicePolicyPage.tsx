    ...
    <>
      <div className="bg-[#09071631] w-full fixed top-0 left-0 right-0 z-99999 backdrop-blur-md to-transparent via-[#0b0614]/80 from-[#0b0614]">
        <div className="ts-1st-line flex items-center justify-between h-21 border-y border-gray-800 px-20">
          ...
          <NavLink
            to={"/"}
            className="flex gap-2 font-medium text-gray-500 hover:text-[#00FF00] cursor-pointer"
          >
            <ArrowLeft />
      ...
      <main className="bg-background w-[55%] mx-auto flex flex-col gap-10 py-30">
        <header className="flex flex-col gap-5">
          <h1 className="font-bold text-5xl">
            Terms of Service and <span className="text-[#00FF00]">Policy</span>
          </h1>
          ...
          {terms.map((item) => (
            ...
            >
              <div className="ts-term-title flex items-center gap-3">
                <div className="id-wrapper w-8 h-8 rounded-full flex justify-center items-center bg-[#4c674c]">
                  <span className="text-[#00FF00]">{item.id}</span>
                </div>
        ...
        <Button
          size="lg"
          className="bg-[#00FF00] cursor-pointer mx-auto text-black hover:bg-[#00FF00] font-semibold px-7 py-6 rounded-xl shadow-lg shadow-[#00FF00]/50 transition-all hover:shadow-[0_0_30px_8px_rgba(236,72,153,0.7)]"
        >
